window.addEventListener("load", () => {
  function makePalette() {
    ...
    const theColorNames = `${nameCola.name} (${hexCola}), <br>${nameColb.name} (${hexColb}), <br>${nameColc.name} (${hexColc}), <br>${nameCold.name} (${hexCold}), and <br>${nameCole.name} (${hexCole})`;


    let altText = `a block of five color swatches in ${nameCola.name} (${hexCola}), ${nameColb.name} (${hexColb}), ${nameColc.name} (${hexColc}), ${nameCold.name} (${hexCold}), and ${nameCole.name} (${hexCole})`;

    console.log(`"altText: ${altText}"`);

    let vertPaletteTable = `<div id="vertPalette" role="img" aria-label="${altText}" style="width:225px;height:175px;display:inline-block;text-align:center;font-family:Trebuchet MS;font-size:0.7em;"><title>${altText}</title><div style="width:45px;height:175px;display:inline-block;background-color:${hexCola};color:${hexColaContrast};padding:5px 0;">${hexCola}</div><div style="width:45px;height:175px;display:inline-block;background-color:${hexColb};color:${hexColbContrast};padding:5px 0;">${hexColb}</div><div style="width:45px;height:175px;display:inline-block;background-color:${hexColc};color:${hexColcContrast};padding:5px 0;">${hexColc}</div><div style="width:45px;height:175px;display:inline-block;background-color:${hexCold};color:${hexColdContrast};padding:5px 0;">${hexCold}</div><div style="width:45px;height:175px;display:inline-block;background-color:${hexCole};color:${hexColeContrast};padding:5px 0;">${hexCole}</div></div>`;

    let horizPaletteTable = `<div id="horizPalette" role="img" aria-label="${altText}" style="width:225px; height:185px;  text-align:center; line-height:35px; font-family:Trebuchet MS; font-size:1em; word-break:break-word;"><title>${altText}</title><div style="height:37px;width:225px;background-color:${hexCola};color:${hexColaContrast}"><div style="display:inline-block;width:223px;line-height:1;vertical-align:middle">${nameCola.name} ${hexCola}</div></div><div style="height:37px;width:225px;background-color:${hexColb};color:${hexColbContrast}"><div style="display:inline-block;width:223px;line-height:1;vertical-align:middle">${nameColb.name} ${hexColb}</div></div><div style="height:37px;width:225px;background-color:${hexColc};color:${hexColcContrast}"><div style="display:inline-block;width:223px;line-height:1;vertical-align:middle">${nameColc.name} ${hexColc}</div></div><div style="height:37px;width:225px;background-color:${hexCold};color:${hexColdContrast}"><div style="display:inline-block;width:223px;line-height:1;vertical-align:middle">${nameCold.name} ${hexCold}</div></div><div style="height:37px;width:225px;background-color:${hexCole};color:${hexColeContrast}"><div style="display:inline-block;width:223px;line-height:1;vertical-align:middle">${nameCole.name} ${hexCole}</div></div>`;
    ...
    document.getElementById("nameSpot").innerHTML = theColorNames;
