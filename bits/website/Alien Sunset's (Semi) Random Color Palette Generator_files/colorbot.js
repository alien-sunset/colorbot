window.addEventListener("load", () => {
  function makePalette() {
    ...
    let horizPaletteTable = `<div id="horizPalette" role="img" aria-label="${altText}" style="width:225px;height:175px;display:inline-block;text-align:center;font-family:Trebuchet MS;font-size:.75em;"><title>${altText}</title>
    <div style="box-sizing:border-box;height:35px;width:225px;background-color:${hexCola};color:${hexColaContrast};padding:6px 0;">${nameCola.name} (${hexCola})</div> <div style="box-sizing:border-box;height:35px;width:225px;background-color:${hexColb};color:${hexColbContrast};padding:6px 0;">${nameColb.name} (${hexColb})</div> <div style="box-sizing:border-box;height:35px;width:225px;background-color:${hexColc};color:${hexColcContrast};padding:6px 0;">${nameColc.name} (${hexColc})</div> <div style="box-sizing:border-box;height:35px;width:225px;background-color:${hexCold};color:${hexColdContrast};padding:6px 0;">${nameCold.name} (${hexCold})</div> <div style="box-sizing:border-box;height:35px;width:225px;background-color:${hexCole};color:${hexColeContrast};padding:6px 0;">${nameCole.name} (${hexCole})</div>`;
